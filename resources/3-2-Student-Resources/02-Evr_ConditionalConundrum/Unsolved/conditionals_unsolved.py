...
if 2 * x > 10:
    ...
    print("oooo needs some work") # prints
...
if name in group_one:
    ...
    print(name + " is in group three") # prints!!
else:
...
if (height > 70) and (age >= 18):
    ...
    print("Can ride bumper cars") #prints
else:
